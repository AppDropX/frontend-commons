...
/// Asks before removing a cart line — used for delete tap and minus at qty 1.
Future<bool> showCartRemoveConfirmDialog(BuildContext context) async {
  // Dialog routes sit above the page overlay — inherit [AppDropThemeScope]
  // from the caller here, same pattern as [showProductSelectionBottomSheet].
  ...
  final result = await showDialog<bool>(
    ...
    builder: (dialogContext) {
      Widget dialog = const _CartRemoveConfirmDialog();
      if (themeConfig != null) {
...
class _CartRemoveConfirmDialog extends StatelessWidget {
  const _CartRemoveConfirmDialog();
